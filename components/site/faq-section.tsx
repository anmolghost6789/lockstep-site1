...
const faqs = [
  ...
  },
  {
    ...
    answer: 'A pilot is a fixed fee agreed up front, and it converts into your first year if you continue. After that, pricing is per developer for one team, or an annual contract for the organisation. See Pricing above for the details.',
  },
];
