        ...
        <div className="relative z-10 flex flex-col items-start justify-center gap-3 px-4 pb-10 pt-12 text-start sm:pt-16 lg:w-[46%] lg:min-w-[440px] lg:pt-0 lg:pb-16 lg:pe-8 xl:ps-6">
          ...
          <AnimateEnter delay={0.28} isWhileInView={false}>
            <p className="max-w-[548px] text-pretty font-inter text-[14px] font-medium leading-[20px] text-[#646464]">
              Lockstep runs your delivery process on the GitHub Copilot you already have. Agents do the work in
              each phase; a named person approves it before the next one starts.
            </p>
          </AnimateEnter>
